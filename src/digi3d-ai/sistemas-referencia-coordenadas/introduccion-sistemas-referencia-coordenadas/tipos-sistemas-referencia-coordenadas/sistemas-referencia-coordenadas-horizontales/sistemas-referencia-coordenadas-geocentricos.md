...
Digi3D.AI en ocasiones debe transformar coordenadas de un determinado sistema de coordenadas determinado a un sistema de coordenadas geocéntrico.
...
Digi3D.AI no te va a permitir seleccionar como sistema de referencia de coordenadas uno geocéntrico, pero internamente lo va a utilizar \(por ejemplo al calcular orientaciones absolutas, el cálculo en ocasiones se realiza en coordenadas geocéntricas\).
