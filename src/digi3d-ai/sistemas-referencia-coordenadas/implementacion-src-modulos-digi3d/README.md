...
En esta sección se va a explicar cuáles de esos módulos tienen asignado un sistema de referencia de coordenadas, cómo cambiar el sistema de referencia de coordenadas de dichos módulos así como en qué momento Digi3D.AI transforma coordenadas al sistema de referencia de coordenadas de un módulo en particular.
