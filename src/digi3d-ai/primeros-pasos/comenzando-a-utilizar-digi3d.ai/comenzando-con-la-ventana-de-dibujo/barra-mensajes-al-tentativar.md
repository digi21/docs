...
1. **Abre** el fichero **cartografía\_en\_etrs89.bind**.
2. **Tentativa** una entidad cualquiera con el [botón de tentativo](barra-mensajes-al-tentativar.md) del ratón. En la esquina inferior izquierda se encuentra la **Barra de mensajes** de **Digi3D.AI**, en ella aparecerá información sobre la entidad que has tentativado. Ve seleccionando distintas entidades y observa la información que aparece sobre cada una de ellas en la **Barra de mensajes**.
