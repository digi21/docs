...
3. Si quieres eliminar el último vértice digitalizado pulsa sobre el **tercer botón** de la [Barra de herramientas Finalización de polilínea](/digi3d-ai/referencia/barras-de-herramientas/finalizacion-de-polilinea.md), es el correspondiente a **Retroceder**, que eliminará el último segmento de la línea que estés digitalizando.
4. Si pulsas el botón **Retroceder**, eliminando todos los vértices de la polilínea, cuando ya no existan más segmentos para retroceder, **Digi3D.AI**, finalizará la orden [LINEA](/digi3d-ai/referencia/ventana-de-dibujo/ordenes/l/linea.md).
...
2. Pulsa el **último botón** de la [Barra de herramientas Finalización de polilínea](/digi3d-ai/primeros-pasos/comenzando-a-utilizar-digi3d.ai/comenzando-con-la-ventana-de-dibujo/BarraDeHerramientasFinalizaci-nDePolilinea.html) para activarlo, es el correspondiente a la orden [UM](/digi3d-ai/referencia/ventana-de-dibujo/ordenes/u/um.md).
3. **Digi3D.AI** solicita que "_Marque el segmento a partir del cual borrar_", selecciona un segmento cualquiera haciendo **clic** con el [botón de dato](eliminando-ultimos-segmentos.md) del ratón sobre él. Se eliminan todos los segmentos digitalizados hasta ese.
