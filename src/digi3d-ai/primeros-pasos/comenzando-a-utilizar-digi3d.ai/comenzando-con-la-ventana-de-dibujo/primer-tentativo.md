...
1. **Dibuja** una [línea](/digi3d-ai/primeros-pasos/comenzando-a-utilizar-digi3d.ai/comenzando-con-la-ventana-de-dibujo\dibujando-primeras-lineas.md) con tres vértices.
...
4. Pulsa el botón **Deshacer** de la [Barra de herramientas Deshacer](/digi3d-ai/referencia/barras-de-herramientas/deshacer.md), para eliminar la última línea dibujada.
...
1. Pulsa el **botón central** del ratón en un área en la que no exista ninguna entidad, comprobarás que Digi3D.AI genera un sonido de error para indicar que no ha localizado ninguna entidad en ese área.
