...
Esta categoría permite configurar Digi3D.AI para generar archivos de depuración que nos permitan detectar problemas.
...
* **Si**. Selecciona esta opción si quieres que Digi3D.AI cree un archivo de LOG y almacene en ese archivo todas las operaciones que va realizando el usuario.
