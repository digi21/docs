...
| :--- | :--- | :--- | :--- |
| 1 | Ubicación a la que desplazar la ventana fotogramétrica al finalizar una línea |**0**: Permanecer en el sitio.<br>**1**: Ir al principio de la línea.<br>**2**: Ir al principio de la línea incrementando la coordenada Z al siguiente múltiplo de equidistancia.<br>**3**: Ir al principio de la línea decrementando la coordenada Z al anterior múltiplo de equidistancia.<br>**4**: Permanecer en el sitio pero incrementar la coordenada Z al siguiente múltiplo de equidistancia.<br>**5**: Permanecer en el sitio pero decrementar la coordenada Z al anterior múltiplo de equidistancia.| No |
