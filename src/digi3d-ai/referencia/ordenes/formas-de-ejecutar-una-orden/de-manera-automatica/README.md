...
Las órdenes que se ejecutarán dependerán de si el código activo tiene asignados o no órdenes en el campo [**Ordenes (pulsar dato)**](/digi3d-ai/referencia/editor-de-tablas-de-codigos/pestanas/codigos/propiedades-del-codigo.md) en la tabla de códigos.
...
* Si el código activo es el asignado en la orden [COD_COTAS](../../../ventana-de-dibujo/ordenes/c/cod-cotas.md) se ejecutará de manera automática la orden [COTA](/digi3d-ai/referencia/ventana-de-dibujo/ordenes/c/cota.md).
