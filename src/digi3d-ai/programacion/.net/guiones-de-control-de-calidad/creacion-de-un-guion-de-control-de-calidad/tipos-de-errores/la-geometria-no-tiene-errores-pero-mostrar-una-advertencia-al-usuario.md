...
El guion puede comunicar una advertencia a Digi3D.AI para que éste muestre un globo al usuario cuando almacene la geometría lanzando una excepción de tipo [System.ComponentModel.WarningException](https://docs.microsoft.com/en-us/dotnet/api/system.componentmodel.warningexception?view=net-5.0) como en el siguiente ejemplo:
