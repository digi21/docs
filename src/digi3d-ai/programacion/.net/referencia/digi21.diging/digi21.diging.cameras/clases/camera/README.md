...
|  |  |
| :--- | :--- |
| ToString() |Convierte este [Entity](../../../digi21.diging.entities/clases/entity/) en una cadena legible para los humanos.<br>(Heredado de [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object?view=net-5.0))|
