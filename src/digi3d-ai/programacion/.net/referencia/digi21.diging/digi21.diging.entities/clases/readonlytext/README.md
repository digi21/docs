...
| [Distance(Point3D)](../../interfaces/isnapable/metodos/distance.md) |Devuelve un vector cuyo módulo es la distancia al punto más cercano al [ReadOnlyPolygon](../readonlypolygon/).<br>(Heredado de [ISnapable](../../interfaces/isnapable/))|
