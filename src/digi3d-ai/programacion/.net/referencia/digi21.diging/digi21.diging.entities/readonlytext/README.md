...
|  |  |
| :--- | :--- |
| [Clone()](metodos/clone.md) | Devuelve una nueva instancia de [Text](../text/) idéntica a la actual pero que no está asignada a ningún [IDrawingFile](../../digi21.diging.io/idrawingfile/) de manera que no es de solo lectura. |
| [Distance(Point3D)](../isnapable/metodos/distance.md) |Devuelve un vector cuyo módulo es la distancia al punto más cercano al [ReadOnlyPolygon](../readonlypolygon/).<br>(Heredado de [ISnapable](../isnapable/))|
