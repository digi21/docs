...
Esta herramienta permitirá transformar las coordenadas de un documento mediante varios tipos de transformaciones. Se mostrara un cuadro de diálogo donde se podrá elegir el tipo de transformación y los parámetros de esta.
