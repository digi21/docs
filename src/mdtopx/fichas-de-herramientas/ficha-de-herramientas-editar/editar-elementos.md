...
* **Seleccionar**: Este comando muestra un menú donde se puede elegir la forma de seleccionar elementos gráficamente. Cada vez que se realice una nueva selección, se descartará la selección actualmente activa, excepto si se mantiene pulsada la tecla mayúscula durante la selección. Las opciones posibles son las siguientes:
  ...
  * [_Según coordenadas_](../../otras-herramientas/editar-elementos/seleccionar-segun-coordenadas.md): Permite la selección en función de las coordenadas de las entidades.
  * [_Según propiedades_](../../otras-herramientas/editar-elementos/seleccionar-segun-propiedades.md): Permite la selección en función de las propiedades de las entidades.
...
* **Unir**: Se dispone de tres opciones:
  ...
  * [_Juntar entidades cercanas_](../../otras-herramientas/editar-elementos/juntar-entidades-cercanas.md): Mediante esta herramienta se pueden juntar entidades en función de la cercanía de sus extremos.
