...
```bash
MDTopX [archivo de entrada] /EXPORT [archivo de salida]
```
...
* **Límite**: 0 (no exportar límite del MDT) o 1 (exportar límite del MDT). Sólo utilizado para exportar en formato BIN, DXF o DGN.
...
* **Triángulos**: 0 (no exportar triángulos) o 1 (exportar triángulos). Sólo utilizado para exportar en formato BIN, DXF o DGN.
* **Vértices**: 0 (no exportar vértices de triángulos) o 1 (exportar vértices de triángulos). Sólo utilizado para exportar en formato BIN, DXF o DGN.
